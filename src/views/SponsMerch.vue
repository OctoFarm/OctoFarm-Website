    ...
    >
      ...
      >
        ...
        >
          ...
          <v-card-text>
            Massive big thank you to everyone below! Everyone here is on my Tier 4+ Patron or a large donator outside of that.
...
export default {
  data: () => ({
    ...
    sponsors: [
      {
        name: "Derek",
        url_title: "3D Printed Debris",
        url: "https://www.3dprinteddebris.com/",
      },
      {
        name: "Insertion",
        url_title: "",
